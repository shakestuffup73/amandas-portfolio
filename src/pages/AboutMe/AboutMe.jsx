  ...
  return (
    ...
    <div className={styles.gridContainer}>
      ...
      <div className={styles.one}>
        ...
        <iframe src="https://open.spotify.com/embed/album/50ZenUP4O2Q5eCy2NRNvuz?utm_source=generator&theme=0" width="90%" height="80" frameBorder="0" loading="lazy" alt="stickseasonalbum" title="noahkahan" id="album"></iframe>
    </div>
  )
}
