  ...
  return (
    ...
    <div className={styles.gridContainer}>
      ...
      <div className={styles.one}>
        ...
        <br></br>
        <br></br>
        After spending almost a decade exploring the states, I've returned to my New England roots. I now spend my free time wandering the woods with my dog, perusing bookshop shelves for hours, staring at the sky and any body of water I happen upon, people-watching under the guise of drinking coffee, and obsessively listening to the music that puts words to my emotions. I'm also a Professional Photographer and appreciate all forms of artistic expression.
        </p>
      </div>
