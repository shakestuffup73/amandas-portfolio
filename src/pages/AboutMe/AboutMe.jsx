  ...
  return (
    <div className={styles.gridContainer}>
      <div className={styles.one}>
        ...
        <h3>
        As a Software Engineer, I utilize best practices to create applications and products to meet a variety of business and user needs. I have spent my professional career working project management for software development programs in the Air Force and as a Park Ranger, where I managed SQL databases, making maps for the Bureau of Land Management. From these experiences I was inspired to pursue Software Development full-time and made the career-switch by attending an immersive Software Engineering bootcamp through General Assembly.  
        </h3>
        <h3>
        After spending almost a decade exploring the states, I've returned to my New England roots. I now spend my free time wandering the woods with my dog, perusing bookshop shelves for hours, staring at the sky and any body of water I happen upon, people-watching under the guise of drinking coffee, and obsessively listening to the artists that bring my emotions to words through introspective lyrical poeticism. I'm a non-commital professional Photographer and love all forms of artistic expression.
        </h3>
